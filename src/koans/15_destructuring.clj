...
(meditations
 ...
 (= (str "An Oxford comma list of apples, "
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Lambda Guru"
     ...
     (apply str (clojure.string/join " aka " (cons (str first-name " " last-name) aliases)))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[first-name last-name] {:keys [street-address city state]}]
        (apply str (clojure.string/join ", " (list (str first-name " " last-name) street-address city state))))["Test" "Testerson"] test-address)))
